...
initial_par <- c(300) #,10)
  ...
  optim_Result <- optim(initial_par, Closed.form.function.1 , NULL, method = "L-BFGS-B", 
                        lower = c(100), #,10),
                        upper= runif(1, 450.000, 500.000), #,12),
...
write_xlsx(FinalOutput.Data.Frame, "D:/work/Rcode/SinterBoiler_SuctionFanRPM_Control/Output/Optimal SuctionFan RPM_ver2.xlsx")
